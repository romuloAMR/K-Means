...
public class KmeansBenchmark {
    ...
    public void setupTrial() throws Exception {
        ...
        this.pool = new ForkJoinPool(this.numWorkers);
        this.threshold = Math.max(100, this.cachedPoints.size() / (this.numWorkers * 4));
    }
    ...
    public void benchmarkClusteringStep(BenchmarkState state) throws Exception {
        ...
        state.kmeans.clustering(this.pool, this.threshold);
    }
    ...
    public void benchmarkUpdateCentroidsStep(BenchmarkState state) throws Exception {
        ...
        state.kmeans.updateCentroids(this.pool, this.threshold);
    }
