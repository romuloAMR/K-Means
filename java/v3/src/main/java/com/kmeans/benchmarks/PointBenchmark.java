...
public class PointBenchmark {
    ...
    public void setup() throws Exception {
        p1 = new Point(new double[]{1, 2, 3, 4, 5});
        p2 = new Point(new double[]{5, 4, 3, 2, 1});
        base1 = new Point(new double[]{1, 2, 3});
        baseDivide = new Point(new double[]{10, 20, 30});
    }
    ...
    public Point benchmarkAccumulatedDivide() throws Exception {
        baseDivide.accumulatedDivide(2.0);
        return baseDivide;
    }
}
